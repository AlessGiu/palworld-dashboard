...
recettes/ingrédients/effets exacts.
"""
...
RECIPES = [
    ...
    ("Cake", "Cooking Pot", {"Flour": 2, "Honey": 2, "Milk": 7, "Egg": 8, "Red Berries": 8}, 8, "Élevage uniquement"),
    ...
    ("Herb Roasted Lamball", "Cooking Pot", {"Lamball Mutton": 1, "Red Berries": 2}, 11, "+10% défense"),
    ("Jam-filled Bun", "Cooking Pot", {"Flour": 1, "Red Berries": 2}, 6, None),
    ("Marinated Mushrooms", "Cooking Pot", {"Mushroom": 1, "Red Berries": 2}, 7, "+10% défense"),
    ("Omelet", "Cooking Pot", {"Tomato": 1, "Egg": 2}, 7, "+10% attaque"),
    ("Pancake", "Cooking Pot", {"Flour": 1, "Milk": 1}, 5, "SAN ralentie"),
    ...
    ("Stewed Galeclaw", "Cooking Pot", {"Galeclaw Poultry": 1, "Red Berries": 2}, 12, "SAN ralentie"),

    ("Carbonara", "Electric Kitchen", {"Flour": 1, "Egg": 2, "Milk": 2}, 16, "+20% défense"),
    ...
    ("Eikthyrdeer Stew", "Electric Kitchen", {"Eikthyrdeer Venison": 1, "Mushroom": 1, "Milk": 2}, 27, "+20% défense"),
    ("Fried Chikipi", "Electric Kitchen", {"Chikipi Poultry": 1, "Flour": 1, "Egg": 1, "High Quality Pal Oil": 1}, 14, "+30% vitesse de travail, SAN ralentie"),
    ("Mozzarina Cheeseburger", "Electric Kitchen", {"Mozzarina Meat": 1, "Flour": 1, "Tomato": 2, "Milk": 2}, 36, "+20% attaque, faim ralentie"),
    ("Mozzarina Hamburger", "Electric Kitchen", {"Mozzarina Meat": 1, "Flour": 1, "Lettuce": 2}, 20, "+50% vitesse de travail, SAN ralentie"),
    ("Pizza", "Electric Kitchen", {"Flour": 1, "Red Berries": 2, "Tomato": 2, "Milk": 2}, 23, "+30% vitesse de travail, faim ralentie"),
    ("Rushoar Hot Dog", "Electric Kitchen", {"Rushoar Pork": 1, "Flour": 1, "Lettuce": 2}, 18, "+20% défense"),

    ("Mammorest Curry", "Grand Four", {"Mammorest Meat": 1, "Onion": 2, "Carrot": 2, "Potato": 2, "Red Berries": 2}, 52, "qualité épique"),
    ...
    ("Galeclaw Nikujaga", "Grand Four", {"Galeclaw Poultry": 1, "Onion": 2, "Carrot": 2, "Potato": 2}, 19, "+25% défense (10 min)"),
]
